...
$L['adm_help_config_rss'] = "Ссылки для вызова RSS лент:<br />rss.php (по-умолчанию, выводятся новости из категории указанной в настройках)<br />rss.php?m=pages&c=XX (XX - код категории, последние страницы из категории)<br />rss.php?m=comments&id=XX (XX - ID страницы, комментарии к странице)";
