...
$L['adm_help_config_rss'] = "RSS beslemelerini açmak için linkler: <br />rss.php (Varsayılan olarak, ayarlarda belirtilen haber kategorilerinin çıktısı) <br /> rss.php?m=pages&c=XX (XX - Kategori kodu, kategorinin son sayfaları) <br />rss.php?m=comments&id=XX (XX - ID sayfası, yorumlar sayfası) ";
...
$L['adm_help_trashcan'] = "Kullanıcılar ve moderatörler tarafından en son silinen öğeleri burada listeledik.<br />&nbsp;<br />Sil: Öğeyi sonsuza kadar sil.<br />Düzeltme: Öğeyi tekrar veritabanına geri yükle."; 
