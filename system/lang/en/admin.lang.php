...
$L['adm_help_config_rss'] = "Links to open RSS feeds: <br />rss.php (by default, the output of news categories specified in the settings) <br /> rss.php?m=pages&c=XX (XX - Category code, the last pages of the category) <br />rss.php?m=comments&id=XX (XX - ID page, comments page)";
...
$L['adm_help_trashcan'] = "Here are listed the items recently deleted by the users and moderators.<br />&nbsp;<br />Wipe : Delete the item forever.<br />Restore : Put the item back in the live database."; 
