...
$pagecatpathurl = sed_build_catpath($pag['page_cat'], "%1\$s"); 
...
{
$pag['page_thumb'] = "".$pag['page_thumb']."";
}
else
{
$pag['page_thumb'] = "plugins/pagethumb/inc/14-thumb.gif";
}
