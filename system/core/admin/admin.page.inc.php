   ...
   // $adminmain .= "<h4>".$L['Structure']."</h4>";
    ...
    if ($n=='options')
    	...
    	while ($row = sed_sql_fetchassoc($sql))
    		...
    		$st_group = "<select name=\"s[$structure_id][rgroup]\" size=\"0\">";   
    		for ($i=0; $i<3; $i++)
    			{
