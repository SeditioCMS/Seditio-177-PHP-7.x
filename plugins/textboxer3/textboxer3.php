...
".$smiley."
var tb3textareasName = {'rusertext':'".$tb3_toolbar['users']."','rtext':'".$tb3_toolbar['comments']."','rstext':'".$tb3_toolbar['pages']."','rdesc':'".$tb3_toolbar['users']."','newpagetext':'".$tb3_toolbar['pages']."','rpagetext':'".$tb3_toolbar['pages']."','newpmtext':'".$tb3_toolbar['pm']."'};
var tb3textareasHeight = {'rusertext':'".$tb3_height['users']."','rtext':'".$tb3_height['comments']."','rstext':'".$tb3_height['pages']."','rdesc':'".$tb3_height['users']."','newpagetext':'".$tb3_height['pages']."','rpagetext':'".$tb3_height['pages']."','newpmtext':'".$tb3_height['pm']."'};
