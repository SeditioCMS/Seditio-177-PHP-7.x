...
if(!defined('SED_MESSAGE') && !defined('SED_LIST') && !defined('SED_ADMIN'))
{
...
if ($usr['maingrp'] > 3) {
 ...
 $CkTextareas_option .= "CkTextareasName['newpagetext2'] = '".$ck_newpagetext_toolbar."'; "."CkTextareasHeight['newpagetext2'] = '".$ck_newpagetext_height."';";
  $CkTextareas_option .= "CkTextareasName['rpagetext2'] = '".$ck_rpagetext_toolbar."'; "."CkTextareasHeight['rpagetext2'] = '".$ck_rpagetext_height."';";
