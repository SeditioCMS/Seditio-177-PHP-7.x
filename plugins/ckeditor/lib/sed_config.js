CKEDITOR.editorConfig = function( config )
{
  ...
  config.extraPlugins = 'more','imageresponsive','youtube','iframedialog';
  ...
  [
    ...
    ['Link','Unlink','Anchor','VideoDetector'],
  ...
  [
    ...
    ['Link','Unlink','Anchor'], ['Image','Youtube','MediaEmbed','VideoDetector'],  
  ...
  [
    ...
    ['Image','Youtube','MediaEmbed','VideoDetector','Link','Unlink','Anchor','Smiley'],
    ['TextColor','BGColor'],
